...
#             # 2. Load the pipeline and strictly assign it to the CPU
#             print("Loading model... (This might take a few minutes on the first run)")
#             pipe = StableDiffusionPipeline.from_pretrained(model_id)
#             import torch
#             pipe = pipe.to("cpu")

#             print("Device being used for image generation:", pipe.device)

#             # 3. Define your text prompt
#             prompt = f"{prompt}"

#             # 4. Generate the image
#             # 'num_inference_steps' is lowered to 15-20 to make CPU rendering significantly faster
#             print("Generating image on CPU... Please wait.")
#             image = pipe(prompt, num_inference_steps=20).images[0]

#             # 5. Save the image locally
#             output_path = "cpu_generated_image.png"
